...
public class GetNetworkAddress {                                            // classe utile a recuperare l'indirizzo Ip e Mac della macchina
    ...
    public static String GetAddress(String addressType) {
        ...
        try {
            ...
            while (net.hasMoreElements()) {
                ...
                while (addresses.hasMoreElements() && !isVMMac(element.getHardwareAddress())) {                 /*Fix*/
